...
#    camera = TaskContext.get 'camera_usb_deployment'  
    ...
    cpmf.apply_conf_file("scripts/cpmf.yml",["entern"])
    cpmf.configure
    cpmf.start

    log.camera.frame.connect_to fsi.input_image
...
#    imgR = Vizkit.display fsi.right_image
    ...
    Vizkit.display cpmf.camera1_out
    Vizkit.display cpmf.camera2_out
